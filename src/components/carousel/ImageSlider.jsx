			...
			{images.map((item) => (
			  <div key={item.url}>
				<div className="tag clr " >
					...
					<a href={item.url} target="_blank"><img src={item.urlToImage}  alt="..." style={{ width: "50%", height: "30%" }} />
...
// 				return <div className="carousel" key={element.url}>
// 				<Images title={element.title} description={element.description} urlToImage={element.urlToImage} url={element.url}/> 
